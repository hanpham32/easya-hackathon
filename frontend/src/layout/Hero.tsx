    ...
    <section>
      <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 overflow-hidden md:px-8 md:flex">
        <div className='flex-none space-y-5 max-w-xl'>
          ...
          <p>
            On Workshops Hub, you don&apos;t just learn -- you build, deploy real projects, and mastering your craft with every push
          </p>
          <div className='flex items-center gap-x-3 sm:text-sm'>
            <a href="/get-started" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 duration-150 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex">
              Get started
        ...
        <div className='flex-1 hidden md:block'>
          ...
          <Image src="./hero-bg.svg" className="max-w-xl" color="red" alt="hero-bg" width={500} height={500} />
        </div>
      </div>
    </section>
  )
